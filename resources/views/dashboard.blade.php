            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ \App\Models\Invoices::where('status', 'غير مدفوعة')->sum('total') }}</h4>
                            <p class="mb-0 tx-12 text-white op-7">عدد الفواتير
                                {{ \App\Models\Invoices::where('status', 'غير مدفوعة')->count()}}</p>
                        </div>
                        <span class="float-right my-auto mr-auto">
                            ...
                            <span class="text-white op-7">
                                ...
                                $count_invoices2 = \App\Models\Invoices::where('status', 'غير مدفوعة')->count();
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ \App\Models\Invoices::where('status', 'مدفوعة')->sum('total') }}</h4>
                            <p class="mb-0 tx-12 text-white op-7">عدد الفواتير
                                {{ \App\Models\Invoices::where('status', 'مدفوعة')->count()}}</p>
                        </div>
                        <span class="float-right my-auto mr-auto">
                            <i class="fas fa-arrow-circle-up text-white"></i>
                            <span class="text-white op-7">
                                @php
                                $count_all= \App\Models\Invoices::count();
								$count_invoices1 = \App\Models\Invoices::where('status', 'مدفوعة')->count();
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ \App\Models\Invoices::where('status', 'مدفوعة جزئيا')->sum('total') }}</h4>
                            <p class="mb-0 tx-12 text-white op-7">عدد الفواتير
                                {{ \App\Models\Invoices::where('status', 'مدفوعة جزئيا')->count()}}</p>
                        </div>
                        <span class="float-right my-auto mr-auto">
                            <i class="fas fa-arrow-circle-down text-white"></i>
                            <span class="text-white op-7">
							@php
                                        $count_all= \App\Models\Invoices::count();
                                        $count_invoices1 = \App\Models\Invoices::where('status', 'مدفوعة جزئيا')->count();
                                ...
                                {{-- round(\App\Models\Invoices::where('status', 'مدفوعة جزئيا')->count() / \App\Models\Invoices::count() * 100) --}}
                            </span>
                        </span>
                    </div>
                </div>
